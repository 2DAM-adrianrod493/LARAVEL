            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{route('recetas.edit', [$categoria, $receta])}}" class="btn btn-warning">Editar receta</a>
                        <form action="{{route('recetas.delete', [$categoria, $receta])}}" method="post" class="mt-1">
                            @csrf
                            @method('delete')
